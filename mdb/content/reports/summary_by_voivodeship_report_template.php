<div class="form-row">
  ...
  <div class="col-md-1">
    <button class="btn btn-info" id = "voivodeship_summary_data_refresh"><span id="voivodeship_summary_data_refresh_span">Odśwież/załaduj</span></button>
  </div>
</div>
