function loadItemRegionChart(chart_data) {
  ...
  var itemRegionChart = new Chart(canvas1, {
   type: 'bar',
   data: data,
   options: {
     title: {
  ...
  var itemRegionCountChart = new Chart(canvas2, {
   type: 'bar',
   data: data,
   options: {
     title: {
  ...
  var itemRegionPercentChart = new Chart(canvas3, {
   type: 'bar',
   data: data,
   options: {
     title: {
  ...
  var itemRegionProfitMarginChart = new Chart(canvas4, {
   type: 'bar',
   data: data,
   options: {
     title: {
