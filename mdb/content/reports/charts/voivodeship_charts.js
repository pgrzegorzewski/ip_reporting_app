function loadVoivodeshipChart(chart_data) {
  ...
  var voivodeshipValueTotalChart = new Chart(canvas1, {
   type: 'doughnut',
   data:{
           labels:  labels,
           datasets: [{
  ...
  var voivodeshipPercentChart = new Chart(canvas2, {
   type: 'bar',
   data: data,
   options: {
     title: {
  ...
  var voivodeshipProfitMarginChart = new Chart(canvas3, {
   type: 'doughnut',
   data:{
           labels:  labels,
           datasets: [{
