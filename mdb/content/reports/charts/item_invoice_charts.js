function loadInvoiceItemChart(chart_data) {
  ...
  for (index = 0; index < chart_data_suma_wartosci.length; index++) {
    datasets.push({label:chart_data_suma_wartosci[index].faktura_numer, backgroundColor: colors[index], data:[chart_data_suma_wartosci[index].suma_wartosci]});
    if(index == 9) {
      break;
    }
  }
  ...
  var itemChart = new Chart(canvas1, {
   ...
   options: {
     title: {
       display: false,
       text: 'Top 10 faktur z towarem (wartość)'
     },
     barValueSpacing: 5,
     scales: {
       yAxes: [{
  ...
  var itemCountChart = new Chart(canvas2, {
   ...
   options: {
     title: {
       display: false,
       text: 'Top 10 faktur z towarem  (ilość)'
     },
     barValueSpacing: 5,
     scales: {
       yAxes: [{
  ...
  var itemPercentChart = new Chart(canvas3, {
   ...
   options: {
     title: {
       display: false,
       text: 'Top 10 faktur z towarem  (procent)'
     },
     barValueSpacing: 5,
     scales: {
       yAxes: [{
  ...
  var itemProfitMarginChart = new Chart(canvas4, {
   ...
   options: {
     title: {
       display: true,
       text: 'Top 10 faktur z towarem  (marża)'
     },
     barValueSpacing: 5,
     scales: {
       yAxes: [{
