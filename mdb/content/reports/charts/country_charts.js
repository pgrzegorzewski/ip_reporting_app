function loadCountryChart(chart_data) {
  ...
  var countryValueTotalChart = new Chart(canvas1, {
   type: 'doughnut',
   data:{
           labels:  labels,
           datasets: [{
  ...
  var countryPercentChart = new Chart(canvas2, {
   type: 'bar',
   data: data,
   options: {
     title: {
  ...
  var countryProfitMarginChart = new Chart(canvas3, {
   type: 'doughnut',
   data:{
           labels:  labels,
           datasets: [{
